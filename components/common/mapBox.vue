...
<script>
 export default {
    ...
    methods: {
      init(){
        this.mbgl.accessToken = 'pk.eyJ1IjoibWlsbGlvbWUiLCJhIjoiY2swem8xOWY4MDdrODNucGdoazk0OXB5NSJ9.bkNupD9GOCQ-sHLC26ypOA';
        ...
        var that = this
          map.on('load', function () {
            ...
            "type": "Feature",
            "properties": {
            "description": ' <img src="http://192.168.3.94:8100/picture/homes/15374140007560.jpg" style="width:1.2rem;height:1rem"/>',
            "icon": "music"
            },
            "geometry": {
            "type": "Point",
