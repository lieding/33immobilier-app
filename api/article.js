...
const article = {
  ...
  getRegionalNew(params) {
    return axios.post(
      `${base.sq}/regional/getRegionalNew`,
      qs.stringify(params)
    );
  },
  //根据地区名查询走势
  getTrendByRegion(params) {
    return axios.post(
      `${base.sq}/homePage/getTrendByRegion`,
      qs.stringify(params)
    );
  },
  //获取城市 大省+小省
  ...
  loanCapability(params) {
    return axios.post(
      `${base.sq}/calculator/loanCapability`,
      qs.stringify(params)
    );
  },
  // 还贷计算
  ...
  OrdInfo(params) {
    return axios.post(
      `${base.sq}/home/getPostListingData`,
      qs.stringify(params)
    );
  },
  // 获取租房列表
  getRentingList(params) {
    return axios.post(
      `${base.sq}/renting/getRentingList`,
      qs.stringify(params)
    );
  },
  // 获取租房详情
  ...
  getFacilitatorList(params) {
    return axios.post(
      `${base.sq}/facilitator/getFacilitatorList`,
      qs.stringify(params)
    );
  },
  // 二手房发布
